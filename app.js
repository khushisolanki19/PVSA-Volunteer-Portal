...
const state = {
  ...
  projects: [
    { id:"p1", title:"Second Harvest Food Bank", type:"Hunger Relief", date:"2026-08-02", time:"9:00 AM–1:00 PM", location:"Second Harvest Warehouse", slots:12, status:"Open", hours:4, leadIds:["a1"], description:"Sort and pack nutritious groceries for local families through Second Harvest.", signups:["y1","y2","a1"], waitlist:[], checkedIn:[] },
    { id:"p2", title:"Habitat for Humanity", type:"Community Building", date:"2026-08-16", time:"8:30 AM–11:30 AM", location:"Fremont Build Site", slots:8, status:"Open", hours:3, leadIds:["a1"], description:"Support a Habitat for Humanity build and help prepare materials for volunteers.", signups:["y2","a1"], waitlist:[], checkedIn:[] },
    { id:"p3", title:"Community Donation Drive", type:"Donation Drive", date:"2026-09-05", time:"10:00 AM–2:00 PM", location:"JCNC Main Hall", slots:20, status:"Upcoming", signupDate:"2026-08-20", hours:4, leadIds:["a1"], description:"Collect, sort, and prepare donated essentials for neighbors in need.", signups:[], waitlist:[], checkedIn:[] },
